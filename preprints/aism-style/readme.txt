%                                                             readme.txt
% LaTeX class SVJour3 for the Springer journal
% Annals of the Institute of Statistical Mathematics
%                                           version 1.0 as of 2006/08/02
%
% read-me file
%                                                           (c) Springer
%-----------------------------------------------------------------------
...
Base-URL for updates: ftp://ftp.springer.de/pub/tex/latex/svjour3/10463/
...
The following files are part of the macro package
  ...
  user_guide3.*    Main User's Guide (dvi, pdf)

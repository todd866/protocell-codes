...
\medskip
\noindent\textit{Note:} This protocol prioritizes experimental tractability over prebiotic plausibility. A stripped-down version using only oleic acid vesicles, pH oscillations, and diffusive coupling would be more prebiotically relevant but harder to control and observe.
